...
class Plugin
{
  ...
  {
    wp_register_script('buttons_widgets_script', plugins_url('/assets/js/buttons.js', __FILE__), ['jquery'], false, true);
  }

  public function widget_styles()
  {
    wp_register_style('font-awesome', ELEMENTOR_ASSETS_URL . 'lib/font-awesome/css/font-awesome.min.css', __FILE__);
    wp_register_style('buttons_widgets_style', plugins_url('/assets/css/buttons.css', __FILE__));
  }
  ...
  public function register_widgets()
  {
    ...
    $class_name = $this->reflection->getNamespaceName() . '\Widgets\\' . 'Buttons';
  ...
  public function __construct()
  {
    ...
    add_action('elementor/preview/enqueue_styles', function () {
      wp_enqueue_style('buttons_widgets_style');
    });
